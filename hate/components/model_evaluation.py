...
class ModelEvaluation:
    ...
    def get_best_model_from_s3(self, bucket_name, model_key, local_path) -> str:
        """
        ...
        try:
            ...
            self.s3.download_file(self.model_evaluation_config.BUCKET_NAME,
                                  ...
                                  os.path.join(self.model_evaluation_config.BEST_MODEL_DIR_PATH, self.model_evaluation_config.MODEL_NAME))
    ...
    def evaluate(self):
        ...
        try:
            ...
            logging.info(f"The confusion matrix is {cm}")
